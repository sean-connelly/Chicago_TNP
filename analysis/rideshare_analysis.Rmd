...
**This analysis uses the day of the year that Governor Pritzker's Stay-at-Home Order went into effect (March 21st), as a way to delineate between two time frames when comparing data across years:**

- **"Pre-COVID" (1/1-3/20 for a given year) and **
- **"Post-COVID" (3/21-12/31 for a given year)**
...
The spatial distribution of rideshare trips that started and ended within the City of Chicago during the Pre-COVID period (1/1-3/20) of 2019 and 2020 were very similar. **The maps below display how spatial patterns changed after the Stay-at-Home Order went into effect, relative to 2019.**
...
The spatial distribution of rideshare origins and destinations are very similar. Trips are highly concentrated around the downtown core - note how the scale quickly increases for each map. While the number of trips in 2020 cratered compared to the same period in 2019, most trips started or ended around the central business district. In the Post-COVID periods of both 2019 and 2020, the top three community areas (The Loop, Near North Side, and Near West Side) accounted for over 40 percent of all rideshare trips within the city.
...
```{r origin tracts rank change tmap, fig.width=8}
...
```{r destination tracts rank change tmap, fig.width=8}
